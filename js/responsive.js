...
// <div class="row">
// 	<div class="col-md-5 project">
// 		<div class='proj-title'> Earthquake </div>
// 		<div class="row">
// 			<div class="col-md-6 text-center">
// 				<img class="img-fluid" src="/img-layout/earthquake_plot.png">
// 			</div>
// 			<div class="col-md-6 proj-content">
// 				<ul class="proj-description proj-bullet-description">
// 					<li>Developed visualization where users can fully interact with geographical and temporal features of earthquakes.</li>
// 					<li>Successfully integrated D3.js and Leaflet to produce animations and transitions.</li>
// 					<li>Project featured by Data Science Weekly.</li>
// 				</ul>
// 				<div class="skills"> Skills: D3.js, Leaflet, GeoPandas, Pandas, Python. </div>
// 			</div>
// 		</div>
// 	</div>
